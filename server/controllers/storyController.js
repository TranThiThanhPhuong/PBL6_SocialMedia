...
export const addUserStory = async (req, res) => {
    try {
        ...
        const media = req.file // chi co 1 file media duoc upload len
        let media_url = ''; // luu tru url cua media (image hoac video)

        // neu co media duoc upload len thi tien hanh upload len imagekit
        if (media_type === 'image' || media_type === 'video') {
            ...
            media_url = response.url // lay url cua media vua upload len
        } 
